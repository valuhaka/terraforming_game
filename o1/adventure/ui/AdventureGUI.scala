...
object AdventureGUI extends SimpleSwingApplication:
  ...
  def top = new MainFrame:
    ...
    this.contents = new GridBagPanel:
      ...
      layout += Label("Status:")      -> Constraints(0, 0, 1, 1, 0, 1, NorthWest.id, Fill.None.id, Insets(8, 5, 5, 5), 0, 0)
      layout += Label("Command:")     -> Constraints(0, 1, 1, 1, 0, 0, NorthWest.id, Fill.None.id, Insets(8, 5, 5, 5), 0, 0)
      layout += Label("Information:") -> Constraints(0, 2, 1, 1, 0, 0, NorthWest.id, Fill.None.id, Insets(8, 5, 5, 5), 0, 0)
    ...
    def updateInfo(info: String) =
      ...
      this.locationInfo.text = this.game.toString
